		...
		<div class="modal fade" id="myModal" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<button type="button" class="btn btn-info btn-lg" id="modalBtn2">Open
			Modal2</button>
					
					
					<!-- footer  -->
					<div class="modal-footer">
						<button type="button" class="btn btn-danger saveBtn" data-dismiss="modal">Save</button>
		...
		$(document).ready(function() {
			...
			$(".fileDrop").on("drop",	function(event) {
				...
				$.ajax({
					...
					contentType : false,
					type : 'post',
					success : function(result) { //여기서  responsebody 로 반환한 값을 받는듯 	
